...
<head>
    ...
    <title>@yield('title', 'OBY Job Portal - Dashboard')</title>

    <!-- Fonts -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap">

    <!-- Tailwind + any other CSS -->
...
<body class="bg-orange-50 antialiased">
    <div class="flex h-screen overflow-hidden">
        ...
        <aside id="mobile-sidebar" class="w-64 bg-orange-600 shadow-xl flex-shrink-0 fixed inset-y-0 left-0 transform -translate-x-full transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 lg:block z-40">
            <div class="flex flex-col h-full">
                ...
                <div class="p-6 border-b border-orange-500">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-white">OBY JOB PORTAL</h2>
                ...
                <nav class="flex-1 p-5 space-y-1.5 overflow-y-auto">
                    ...
                    <a href="{{ route('jobs.index') }}" class="flex items-center space-x-3 px-5 py-3.5 text-white rounded-xl hover:bg-orange-700 transition-all {{ request()->routeIs('jobs.*') ? 'bg-orange-700' : '' }}"
                       onclick="this.style.pointerEvents='none'; setTimeout(() => { this.style.pointerEvents='auto'; }, 1000);">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
