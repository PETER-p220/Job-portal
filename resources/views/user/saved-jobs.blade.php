...
<div class="flex h-screen bg-gray-100">
    ...
    <aside class="w-64 bg-white shadow-lg flex-shrink-0">
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 p-4 space-y-1.5 overflow-y-auto">
                ...
                <a href="{{ route('user.saved-jobs') }}" class="flex items-center space-x-3 px-4 py-3 text-indigo-700 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <main class="flex-1 overflow-y-auto">
        <div class="p-6 md:p-8">
            ...
            <p class="text-gray-600 mb-8">Jobs you saved to review later</p>

            <div class="bg-white rounded-xl shadow-sm border border-gray-200 divide-y divide-gray-200">
                @forelse (range(1,4) as $i)
                    <div class="px-6 py-5 hover:bg-gray-50 transition-colors">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            <div>
                                <h3 class="text-lg font-medium text-gray-900">
                                    <a href="#" class="hover:text-indigo-600">Full-Stack Laravel Developer</a>
                                </h3>
                                <p class="text-gray-600">InnoTech Ltd • Dar es Salaam</p>
                                <div class="mt-2 flex flex-wrap gap-3 text-sm text-gray-500">
                                    <span>Salary: TZS 2.5M - 4M</span>
                                    <span>•</span>
                                    <span>Posted 1 week ago</span>
                                </div>
                            </div>
                            <div class="flex items-center gap-4">
                                <button title="Remove from saved" class="text-gray-400 hover:text-red-500">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                    </svg>
                                </button>
                                <a href="#" class="text-indigo-600 hover:text-indigo-800 text-sm font-medium">View Job</a>
                            </div>
                        </div>
                    </div>
                @empty
                    <div class="px-6 py-16 text-center">
                        ...
                        <p class="mt-2 text-gray-500">Save interesting jobs to come back to them easily.</p>
