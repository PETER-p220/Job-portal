...
<div class="p-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600">Manage your administrator account and settings</p>
    </div>
                ...
                <div class="mt-6 pt-6 border-t border-gray-200">
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm font-medium text-gray-900">Full Access</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mt-6">
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-medium text-gray-900">{{ \App\Models\Job::count() }}</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-gray-600">Total Interviews</span>
                        <span class="text-sm font-medium text-gray-900">{{ \App\Models\Interview::count() }}</span>
                    </div>
                    <div class="flex items-center justify-between">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="mb-6">
                    ...
                    <p class="text-gray-600">Update your administrator account information and email address</p>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="mb-6">
                    ...
                    <p class="text-gray-600">Ensure your administrator account is using a strong, secure password</p>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="mb-6">
                    ...
                    <p class="text-gray-600">Manage your administrator account security preferences</p>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        <div>
                            ...
                            <p class="text-sm text-gray-600">View and manage your active login sessions</p>
                        </div>
                        <button class="inline-flex items-center px-4 py-2 bg-gray-600 text-white text-sm font-medium rounded-lg hover:bg-gray-700 transition-colors">
                            View Sessions
                        </button>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-red-200 p-6">
                <div class="mb-6">
                    ...
                    <p class="text-red-600">Once your administrator account is deleted, all of its resources and data will be permanently deleted. This action cannot be undone.</p>
                </div>

                <form method="post" action="{{ route('profile.destroy') }}" onsubmit="return confirm('Are you sure you want to delete your administrator account? This action cannot be undone and will remove all your administrative access.')">
                    @csrf
                    @method('delete')
                    <button type="submit" 
