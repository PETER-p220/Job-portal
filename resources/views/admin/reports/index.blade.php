                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="h-64 flex items-center justify-center bg-gray-50 rounded-lg">
                        <div class="text-center">
                            ...
                            <p class="mt-2 text-sm text-gray-600">Chart visualization would go here</p>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Senior Frontend Developer</td>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Full Stack Engineer</td>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">React Developer</td>
                    ...
                    <div class="p-6 space-y-4">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm text-gray-900">New user registration: <span class="font-medium">John Doe</span></p>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm text-gray-900">New job posted: <span class="font-medium">Senior Developer</span></p>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm text-gray-900">Job application submitted for <span class="font-medium">Frontend Developer</span></p>
